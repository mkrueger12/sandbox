---
allowed-tools: Bash(ast-grep:*), Bash(ls:*), Bash(tree), Bash(git:*), Bash(find:*)
description: Test-Driven Development Feature Implementation
---
## Overview and Context

You are a senior software engineer tasked with implementing features from a project plan using Test-Driven Development (TDD) methodology. Before proceeding review @plan.md, select the single most important unimplemented task and implement it. Once you have selected proceed.
...
## Steps
Your task involves several steps, which we'll break down in detail. 

SELECT ONLY ONE TIME FROM @plan.md TO IMPLEMENT.

1. Review Specifications w/ @agent-spec-implementation-reviewer (Run in Parallel):
