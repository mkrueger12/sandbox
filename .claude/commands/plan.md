...
2. **Spawn initial research tasks to gather context**:
   ...
   - Use the **spec-reviewer** agent to extract key technical requirements of the application, if the specs/ directory exists
   ...
   - Identify the specific directories to focus on (e.g., if ui is mentioned, they'll focus on ui/)
...
- If you need to research specific codebases or have third-party codebase question spawn a subagent with access to the DeepWiki MCP to get clarification and examples to help answer your question.

4. **Present findings and design options to the user**:
   ```
